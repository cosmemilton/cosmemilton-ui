...
//
// `client` já reexporta box.js e chart-frame.js, então aqui repetimos o conteúdo
// de `server` MENOS esses dois módulos para evitar `export *` ambíguo.
export * from "./client.js";

// --- adições server-safe (server.ts, menos box.js e chart-frame.js) ---
